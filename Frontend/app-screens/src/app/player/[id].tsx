...
export default function PlayerDetailScreen() {
  ...
  const { player, passing, receiving, rushing, defense, fantasy } = activeRecord;
      ...
      <View style={styles.statsContainer}>
        ...
        {fantasy && (
          <View style={styles.block}>
            ...
            <View style={styles.grid}>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Standard</ThemedText><ThemedText style={styles.cellVal}>{fantasy.standard}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>PPR Points</ThemedText><ThemedText style={styles.cellVal}>{fantasy.ppr}</ThemedText></View>
            </View>
          </View>
        )}
        ...
        {hasPassing && (
          <View style={styles.block}>
            ...
            <View style={styles.grid}>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Yards</ThemedText><ThemedText style={styles.cellVal}>{passing.yards}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Touchdowns</ThemedText><ThemedText style={styles.cellVal}>{passing.tds}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Completions</ThemedText><ThemedText style={styles.cellVal}>{passing.completions}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Attempts</ThemedText><ThemedText style={styles.cellVal}>{passing.attempts}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Interceptions</ThemedText><ThemedText style={styles.cellVal}>{passing.interceptions}</ThemedText></View>
            </View>
          </View>
        )}
        ...
        {hasRushing && (
          <View style={styles.block}>
            ...
            <View style={styles.grid}>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Yards</ThemedText><ThemedText style={styles.cellVal}>{rushing.yards}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Touchdowns</ThemedText><ThemedText style={styles.cellVal}>{rushing.tds}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Carries</ThemedText><ThemedText style={styles.cellVal}>{rushing.carries}</ThemedText></View>
            </View>
          </View>
        )}
        ...
        {hasReceiving && (
          <View style={styles.block}>
            ...
            <View style={styles.grid}>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Yards</ThemedText><ThemedText style={styles.cellVal}>{receiving.yards}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Touchdowns</ThemedText><ThemedText style={styles.cellVal}>{receiving.tds}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Receptions</ThemedText><ThemedText style={styles.cellVal}>{receiving.receptions}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Targets</ThemedText><ThemedText style={styles.cellVal}>{receiving.targets}</ThemedText></View>
            </View>
          </View>
        )}
        ...
        {hasDefense && (
          <View style={styles.block}>
            ...
            <View style={styles.grid}>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Solo Tackles</ThemedText><ThemedText style={styles.cellVal}>{defense.solo_tackles}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Assists</ThemedText><ThemedText style={styles.cellVal}>{defense.assist_tackles}</ThemedText></View>
              <View style={styles.gridCell}><ThemedText style={styles.cellLabel}>Interceptions</ThemedText><ThemedText style={styles.cellVal}>{defense.interceptions}</ThemedText></View>
            </View>
          </View>
        )}
