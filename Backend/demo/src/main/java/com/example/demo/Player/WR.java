...
public class WR extends AbstractPlayer {

    public WR(List<String> playerData) {
        super(playerData);
    }
    ...
    public List<String> getDetailedInfo() {
        ...
        info.add(format("Targets","Targets"));
        info.add(format("Yards Per Reception","YPR"));
        info.add(format("Long Reception","LongRec"));
        return info;
    }
    ...
    public List<String> getCareerStats() {
        ...
        career.add(format("Career Targets","CareerTargets"));
        return career;
    }
}
